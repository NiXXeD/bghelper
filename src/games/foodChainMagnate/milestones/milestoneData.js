...
export const alternateMilestoneData = [
    {color: '#98C2C9', title: 'marketeer used', text: '$5 for every good your marketeers market; Distance -2.', maxRoundTwo: true},
    ...
    {color: '#BDB6B3', title: 'recruiting girl used', text: 'Get a free executive vice president; Pay no salary for him.', maxRoundTwo: true},
    {color: '#BDB6B3', title: 'trainer used', text: '+1 trainer; No longer need to fire employees if broke.', maxRoundTwo: true},
